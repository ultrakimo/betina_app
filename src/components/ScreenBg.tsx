...
const GLOWS = {
  purple: ['rgba(107,33,168,0.40)', 'rgba(107,33,168,0.12)', 'rgba(10,10,15,0)'],
  gold: ['rgba(255,215,0,0.28)', 'rgba(107,33,168,0.25)', 'rgba(10,10,15,0)'],
  green: ['rgba(191,255,0,0.22)', 'rgba(107,33,168,0.28)', 'rgba(10,10,15,0)'],
} as const;
